    ...
    <section id="government" className="relative">
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-10 md:grid-cols-2 items-center">
          <motion.div className="order-2 md:order-1" initial={{ opacity: 0, x: -12 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5 }}>
            ...
            <ul className="mt-6 space-y-3 text-white/80">
              {[
                ...
                <motion.li key={item} className="flex items-start gap-3" initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.35 }}>
          ...
          <motion.div className="order-1 md:order-2" initial={{ opacity: 0, x: 12 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5 }}>
            <div className="relative rounded-2xl border border-white/10 bg-white/[0.03] p-6 overflow-hidden">
              <motion.div className="absolute -top-5 -left-5 h-28 w-28 rounded-full bg-purple-500/20 blur-2xl" animate={{ x: [0, 6, 0], y: [0, 6, 0] }} transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }} />
              <motion.div className="absolute -bottom-6 -right-6 h-28 w-28 rounded-full bg-blue-500/20 blur-2xl" animate={{ x: [0, -6, 0], y: [0, -6, 0] }} transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut', delay: 0.3 }} />
